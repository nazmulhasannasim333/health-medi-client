const Contact = () => {
  return (
    <div className="my-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12  xl:px-32 py-16  bg-gray-50 text-gray-900 rounded-lg">
